...
bash script/food101/main_exp_20clients/miss_text/20cl.sh
...
for algo in "${algorithms[@]}"; do
    ...
    python main.py \
        --task food101_cnum20_dist0_skew0_seed0_missing_ratio_0.7_0.7_missing_type_text_text_both_ratio_0.0 \
        --model "$algo" \
